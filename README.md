...
## Data Description
In each of our dataset, every line indicates a temporal edge, and has the form $(u_i, u_j, t)$, where $u_i$, $u_j$ represent node $i$ and node $j$, respectively, and $t$ records the established time of the temporal edge. Note that all edges are taken as undirected in this paper. 
